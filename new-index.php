...
<?php  include "testweb/header.php"	?>
	<div class="grid section3 " id="context1">
		...
		<div class="ui top attached tabular menu secondary" id="mytabmenu">
		  <a class="active item" data-tab="first"><span></span></a>
			<a class="item" data-tab="second"><span></span></a>
			<a class="item" data-tab="third" ><span></span></a>
			<a class="item" data-tab="fourth"><span></span></a>
			<a class="item" data-tab="fifth" ><span></span></a>
			<a class="item" data-tab="sixth" ><span></span></a>
		</div>
	</div>
	<div class="grid section4">
		<div class="ui container section3" id="inner-section">	
			...
			<div class="ui tab segment active bg-inner" id="innerWrap2" data-tab="first">	
			 	<?php include "testweb/first.php"	?>      
			</div>
</div>	
<!-- 底部 -->
