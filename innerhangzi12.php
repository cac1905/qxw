...
<?php  include "testweb/header.php"	?>
	...
	<div class="grid section4">
		<div class="ui container section3" id="inner-section">	
			...
			<div class="ui tab segment active bg-inner" id="innerWrap2" >	
			 	<?php include "hangyezixun/pageTop.php" ?>
				<?php include "hangyezixun/pages12.php" ?>
				<?php include "hangyezixun/pageBottom.php" ?>     
			</div>
</div>	
<!-- 底部 -->
